package com.strands.model.mistral;
...
/**
 * Mistral AI model. Mistral exposes an OpenAI-compatible API.
 */
public class MistralModel implements Model {

    private static final String DEFAULT_BASE_URL = "https://api.mistral.ai/v1";
    private static final String DEFAULT_MODEL_ID = "mistral-large-latest";

    private final OpenAIModel delegate;

    public MistralModel(String apiKey) {
        this(apiKey, DEFAULT_MODEL_ID);
    }

    public MistralModel(String apiKey, String modelId) {
        this(apiKey, DEFAULT_BASE_URL, modelId);
    }

    public MistralModel(String apiKey, String baseUrl, String modelId) {
